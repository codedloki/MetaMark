...
import ManProfile from './components/dynamic/manufacturer/ManProfile'
...
import ChatBase  from './components/dynamic/chat/ChatBase.jsx'
import {Popover,PopoverContent,PopoverTrigger} from './components/custom/Popoverit.jsx'
import BaseProduct from './components/dynamic/manufacturer/Product/BaseProduct.jsx'

import Verify from './components/dynamic/customer/Verify'
function App() {
        ...
        <div className="fixed mt-[-86%] md:mt-[-50vh] ml-0 items-left">
          <div className="w-screen">
            ...
            <div className="hidden md:flex">
              <DesktopSidebar  triggerPopup={triggerPopup} />
            </div>
            ...
            <div>
              <Routes>
                ...
                />
                <Route path="/manprofile" element={<ManProfile/>}/>
                <Route path="/chatmain" element={<ChatBase/>}/>
                <Route path="/getstarted" element={<GetStarted />} />
                {/*<Route path="/product/list" element={<ProductList />} />*/}
                <Route path="/product" element={<BaseProduct/>}/>
  ...
  <Registration SuccessToast={showSuccessToast} ErrorToast={showErrorToast}/>
</PopoverContent>
