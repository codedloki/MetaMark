import {
  require_buffer
} from "./chunk-E7NJLS6J.js";
import {
  require_crypto_js
} from "./chunk-JFLBI3ZQ.js";
import {
  require_sha256
} from "./chunk-6R2HING2.js";
import {
  __commonJS
...
var require_MerkleRadixTree = __commonJS({
  "node_modules/merkletreejs/dist/MerkleRadixTree.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var MerkleRadixTree = class extends Base_1.default {
      constructor(hashFn) {
        super();
        this.hashFn = this.bufferifyFn(hashFn);
...
var require_UnifiedBinaryTree = __commonJS({
  "node_modules/merkletreejs/dist/UnifiedBinaryTree.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function getTreeKey(address, treeIndex, subIndex, hashFn) {
      ...
      const treeHash2 = treeHashFn(hashFn);
      const indexBuffer = buffer_1.Buffer.alloc(32, 0);
      indexBuffer.writeUInt32LE(treeIndex, 0);
      const stem = treeHash2(buffer_1.Buffer.concat([address, indexBuffer]), hashFn).subarray(0, 31);
    ...
    var UnifiedBinaryTree = class _UnifiedBinaryTree {
      /**
       ...
       */
      hashData(data) {
        const zero64 = buffer_1.Buffer.alloc(64, 0);
        ...
        function serializeNode(node) {
          ...
          if (node instanceof StemNode) {
            return {
              ...
              values: node.values.map((val) => (
                // Convert 256 values to hex
                val ? val.toString("hex") : null
              ))
      ...
      static deserialize(data, hashFn) {
        ...
        const tree = new _UnifiedBinaryTree(hashFn);
...
// node_modules/merkletreejs/dist/functional.js
var require_functional = __commonJS({
  "node_modules/merkletreejs/dist/functional.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var sha256_1 = __importDefault(require_sha256());
    var defaultHashFn = sha256_1.default;
...
var require_dist = __commonJS({
  "node_modules/merkletreejs/dist/index.js"(exports) {
    ...
    var UnifiedBinaryTree_1 = require_UnifiedBinaryTree();
    Object.defineProperty(exports, "UnifiedBinaryTree", { enumerable: true, get: function() {
      return UnifiedBinaryTree_1.UnifiedBinaryTree;
    } });
    __exportStar(require_functional(), exports);
    exports.default = MerkleTree_1.default;
  }
});
export default require_dist();
//# sourceMappingURL=merkletreejs.js.map
